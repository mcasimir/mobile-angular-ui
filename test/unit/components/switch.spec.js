...
describe('components', function() {
  describe('ui-switch', function() {
    ...
    xit('should handle swipe if $swipe service is present', function() {});
    ...
    // person.enabled === 'S'
    // Thanks.
    xit('should support ng-checked', function() {});
    ...
    // Thanks
    xit('should support ng-true-value ng-false-value', function() {});
    ...
    // I use chrome for debug/test with mobile emulation enabled.
    // Thanks
    xit('should support ng-change', function() {});
  });
});
